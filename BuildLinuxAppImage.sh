...
rm -rf ./AppDir/usr/Source/Core/DolphinQt/project-m-reload-dolphin_autogen
rm ./AppDir/usr/Source/Core/DolphinQt/cmake_install.cmake
rm ./AppDir/usr/bin/project-m-reload-dolphin-nogui
rm ./AppDir/usr/bin/dolphin-tool
mv ./AppDir/usr/share/project-m-reload-dolphin/sys ./AppDir/usr/bin/Sys
rm -rf ./AppDir/usr/share/project-m-reload-dolphin
sed -i 's/env QT_QPA_PLATFORM=xcb project-m-reload-dolphin/project-m-reload-dolphin/g' ./AppDir/usr/share/applications/project-m-reload-dolphin.desktop
